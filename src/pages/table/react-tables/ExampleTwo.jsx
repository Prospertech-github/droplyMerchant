...
const COLUMNS = [
  ...
  },
  {
    ...
    accessor: "recipient",
    Cell: (row) => {
      return <span className="whitespace-nowrap">{row?.cell?.value}</span>;
    },
  },
  {
    Header: "amount",
    ...
    Cell: (row) => {
      return (
        <span>
          {row?.cell?.value.toLocaleString(undefined, {
            style: "currency",
            currency: "NGN",
...
/**
 * @type {Record<Order["status"],{className:""}>}
 */
const statusMap = {
  cancelled: "bg-red-500 text-red-500",
  completed: "bg-success-500 text-success-500",
  confirmed: "bg-purple-500 text-purple-500",
  "in-transit": "bg-orange-500 text-orange-500",
  pending: "bg-yellow-500 text-yellow-500",
  picked: "bg-blue-500 text-blue-500",
};
